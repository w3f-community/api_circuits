...
# podman build -f Dockerfile -t ghcr.io/interstellar-network/api_circuits:dev --volume ~/.cargo:/root/.cargo:rw --volume $(pwd)/target/release:/usr/src/app/target/release:rw .
